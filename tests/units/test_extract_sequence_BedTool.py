...
from gfeat.units import extract_sequence_BedTool


def test_extract_sequence_no_vcf(interval_plus, fasta):
    res = extract_sequence_BedTool(interval_plus, fasta)
    assert res == [("CCCTGAGTCATCCTTGC",)]


def test_extract_sequence_vcf_plus(interval_plus, fasta, vcf):
    res = extract_sequence_BedTool(interval_plus, fasta, vcf)
...
def test_extract_sequence_vcf_minus(interval_minus, fasta, vcf):
    res = extract_sequence_BedTool(interval_minus, fasta, vcf)
